...
# files in the directory and all subdirectories and Y is the number of matching lines found in respective files, where
# a matching line refers to a line which contains searchstr (and may also contain additional content).
